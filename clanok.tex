...
\section{Metódy}
V tejto časti popisujem použité metódy. 
Použil som analýzu dát, simulácie a experimentálne merania.
...
\paragraph{Nový odsek} \label{new}
This is the next paragraph.

\subsection{Zakladý}\label{prečo a ak}
